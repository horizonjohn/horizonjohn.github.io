...
Install Ruby 3.3.5 with [rbenv](https://github.com/rbenv/rbenv), then install the locked dependencies:
...
Open `http://localhost:4000` in your browser. Saved changes are rebuilt and refreshed automatically.
